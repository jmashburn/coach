...
abstract class AbstractHandler {
            ...
            try {
                ...
                if ($resources) {
                    foreach ($resources as $resource) {
                        if (!$this->getAcl()->hasResource($resource['resource_name'])) {
                            $this->getAcl()->addResource($resource['resource_name']);
                        }
                    }
                }

                // Check for Resource Route. Else Add it.
    ...
    public function getLayout() {
        if (!is_file($this->layout) && defined('ROOT_DIR')) {
            $this->layout = ROOT_DIR . '/' . $this->layout;
        }
        return $this->layout;
    }
